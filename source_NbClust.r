structure(list(name = "NbClust", objs = list("package:NbClust" = function (data = NULL, 
    diss = NULL, distance = "euclidean", min.nc = 2, max.nc = 15, 
...
}, function (data = NULL, diss = NULL, distance = "euclidean", 
    min.nc = 2, max.nc = 15, method = NULL, index = "all", alphaBeale = 0.1) 
{
    ...
    if (any(indice == 1) || (indice == 2) || (indice == 3) || 
        ...
        results.final <- list(All.index = res, Best.nc = resultats, 
            Best.partition = partition)
    return(results.final)
}), where = c("package:NbClust", "namespace:NbClust"), visible = c(TRUE, 
FALSE), dups = c(FALSE, TRUE)), class = "getAnywhere")
